...
public class WarpCommand {
    ...
    public void execute(Player sender, @Parameter(value = "list") Warp warp) {
    ...
    public void remove(Player sender, @Parameter(name = "warpName") Warp warp) {
    ...
    public void setLocation(Player sender, @Parameter(name = "warpName") Warp warp) {
    ...
    public void setKit(Player sender, @Parameter(name = "warpName") Warp warp, String kitName) {
