...
public enum Levels {
    ...
    TWENTY(20, 25, 1.15, CC.AQUA),

    THIRTY(30, 30, 1.2, CC.DARK_AQUA),

    FORTY(40, 35, 1.25, CC.BLUE),
    FIFTY(50, 45, 1.3, CC.YELLOW),
    SIXTY(60, 50, 1.35, CC.GOLD + CC.BOLD),
    SEVENTY(70, 55, 1.45,CC.RED + CC.BOLD),
    EIGHTY(80, 60, 1.5, CC.DARK_RED + CC.BOLD),
    NINETY(90, 65, 1.75, CC.LIGHT_PURPLE + CC.BOLD),
    HUNDRED(100, 75, 1.75, CC.DARK_PURPLE + CC.BOLD);
