package rip.thecraft.brawl.spawn.event.schematic;
...
public class SchematicEvent extends TimeEvent {
    ...
    public SchematicEvent(String name) {
    ...
    private File getDirectory() {
        ...
        File file = new File(Brawl.getInstance().getDataFolder(), "/schematics/" + schematic);
