package rip.thecraft.brawl.util.cuboid;

import com.google.gson.JsonObject;
import rip.thecraft.brawl.Brawl;
import rip.thecraft.brawl.util.JsonChain;
import lombok.Data;
...
public class Cuboid implements Iterable<Location> {
    ...
    /**
     * Construct a Cuboid given one Location objects which represent any two
     * corners of the Cuboid.
     *
     * @param loc of both corners
     */
    ...
    /**
     * Constructs a Cuboid given Document object representing corners of
     * Cuboid
     *
     * @param document deserializer
     */
    public Cuboid(Document document) {
        this(document.getString("world"),
                document.getInteger("x1"), document.getInteger("y1"), document.getInteger("z1"),
                document.getInteger("x2"), document.getInteger("y2"), document.getInteger("z2")
        );
    }

    public Cuboid(JsonObject object) {
        this(object.get("world").getAsString(),
                object.get("x1").getAsInt(), object.get("y1").getAsInt(), object.get("z1").getAsInt(),
                object.get("x2").getAsInt(), object.get("y2").getAsInt(), object.get("z2").getAsInt()
        );
    }

    public Document toDocument() {
        return new Document("world", this.worldName)
                .append("x1", this.x1)
                .append("y1", this.y1)
                .append("z1", this.z1)
    ...
    public JsonObject getJson() {
        return new JsonChain("world", this.worldName)
                .append("x1", this.x1)
                .append("y1", this.y1)
                .append("z1", this.z1)
    ...
    public boolean isWithin(int x, int z, int radius) {
        return this.outset(CuboidDirection.BOTH, radius).contains(x, z);
    }
    ...
    public String getFriendlyName() {
        return "(" + this.worldName + ", " + this.x1 + ", " + this.y1 + ", " + this.z1 + ") - (" + this.worldName + ", " + this.x2 + ", " + this.y2 + ", " + this.z2 + ")";
    }
